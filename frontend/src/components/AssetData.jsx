...
function AssetData({currency,pic , category , karat , weight , PurchasePrice , CurrentValue , profitOrLose}) {
    ...
    <div className='hover:-translate-y-3 transition flex flex-col w-full md:w-80 border border-secondary/40 rounded-xl'>
        <div className='pic relative'>
            <img className='rounded-xl' src={pic} alt="asset" />
            <span
        ...
        <div className='p-5'>
            ...
            <div className='flex justify-between items-center mt-2'>
                ...
                <span className='text-profit font-bold text-sm'>+ {currency} {profitOrLose}</span>
            </div>
        </div>
    </div>
  )
